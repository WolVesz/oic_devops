    ...
    def backup_integrations(
        ...
        try:
            ...
            while has_more is True:
                params['offset'] = pages
                integrations_page = self.client.integrations.list(params=params)
                integrations.extend(integrations_page['items'])
                has_more = integrations_page['hasMore']
                if not integrations_page.get('limit'):
                    continue
                pages += integrations_page['limit']
