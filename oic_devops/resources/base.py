...
class BaseResource:
    ...
    def _get_endpoint(
        self, resource_id: Optional[str] = None, action: Optional[str] = None
    ) -> str:
        """
    ...
    def usage(
        ...
        return self.client.get(self._get_endpoint(resource_id)+'/usage', params=params)
    ...
    def update(
        ...
        return self.client.post(
            self._get_endpoint(resource_id=resource_id),
            data=data,
            params=params,
            headers=headers,
        )
