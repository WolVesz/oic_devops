...
CONFIG_SCHEMA = {
    ...
    'additionalProperties': {
        ...
        'properties': {
            ...
            'save_results_directory': {'type': 'string'},
        },
...
class OICConfig:
    ...
    def _load_config(self) -> Dict[str, Any]:
        ...
        if self.config_file:
            ...
            try:
                ...
                raise OICConfigurationError(f'Error loading configuration file: {e!s}')
        ...
        for path in DEFAULT_CONFIG_PATHS:
            if os.path.exists(path):
                try:
                    ...
                    raise OICConfigurationError(
                        f'Error loading configuration file {path}: {e!s}'
                    )
    ...
    def _validate_config(self, config: Dict[str, Any]) -> None:
        ...
        try:
            ...
            raise OICConfigurationError(f'Invalid configuration: {e!s}')
    ...
    @property
    def save_results_directory(self) -> Optional[str]:
        """Get the directory for the current profile, if specified."""
        directory = self.profile_config.get('save_results_directory')
